...
export default function Create() {
    const { employee, expenseTypes } = usePage<{
        employee: Employee;
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Add Expense', href: employees.expenses.create(employee).url },
    ];

    return (
        <PageShell title="Add Employee Expense" breadcrumbs={breadcrumbs}>
            <div>
            ...
            <Form
                {...employees.expenses.store.form(employee)}
